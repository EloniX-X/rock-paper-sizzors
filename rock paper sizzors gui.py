...
window.title("rook papor sizzors game")

#sets baseline for scores
USER_SCORE = 0
COMP_SCORE = 0
USER_CHOICE = ""
COMP_CHOICE = ""
...
#sets computers choice to random
def random_computer_choice():
    return random.choice(['rock','paper','scissor'])

#compares and contrasts choices from input
...
#buttons on the sccrean wich you ccan click
